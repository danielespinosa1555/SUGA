...
const ICONS = {
  ...
  users:    ['M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2','M23 21v-2a4 4 0 0 0-3-3.87','M16 3.13a4 4 0 0 1 0 7.75','M9 7a4 4 0 1 0 0-8 4 4 0 0 8'],
  cog:      ['M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6z','M19.4 15a1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 4.68 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.68a1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z'],
    ...
    <div style={{ display:'flex', height:'100vh', overflow:'hidden', background:'#0F0F1A' }}>
      ...
      <aside style={{
        ...
        <div style={{
          ...
          <span style={{ fontFamily:'"Bebas Neue"', fontSize: 20, color: '#0F0F1A', letterSpacing: '0.05em', lineHeight:1 }}>S</span>
        </div>
        ...
        <nav style={{ flex:1, width:'100%', display:'flex', flexDirection:'column', alignItems:'center', gap: 2, padding:'0 7px', overflowY:'auto' }}>
          {nav.map((item, i) =>
            item === null ? (
              <div key={`d${i}`} style={{ width:28, height:1, background:'#2A2A3A', margin:'6px 0' }} />
            ) : (
        ...
        <div style={{ display:'flex', flexDirection:'column', alignItems:'center', gap:8, padding:'0 7px', width:'100%' }}>
          <div style={{ width:28, height:1, background:'#2A2A3A' }} />
          {/* Bell */}
          <button title="Notificaciones" style={{
            width:40, height:40, borderRadius:8, display:'flex', alignItems:'center', justifyContent:'center',
            background:'transparent', border:'none', cursor:'pointer', color:'#8A89A0',
          ...
          >
            ...
            {unread > 0 && (
              <span style={{ position:'absolute', top:6, right:6, width:7, height:7, borderRadius:'50%', background:'#FF4D6D', border:'2px solid #1A1A24' }} />
            )}
          </button>
          {/* Avatar */}
          <div style={{ width:32, height:32, borderRadius:'50%', background:'#2A2A3A', border:'1px solid #3A3A4A', display:'flex', alignItems:'center', justifyContent:'center', color:'#00D2A0', fontFamily:'"Bebas Neue"', fontSize:13, letterSpacing:'0.05em', cursor:'default' }} title={`${user?.firstName} ${user?.lastName}`}>
            {initials}
          </div>
          {/* Logout */}
      ...
      <div style={{ flex:1, display:'flex', flexDirection:'column', overflow:'hidden' }}>
        ...
        <header style={{
          ...
          {/* Org name */}
          <span style={{ fontFamily:'"DM Mono"', fontSize:10, letterSpacing:'0.1em', textTransform:'uppercase', color:'#8A89A0' }}>
          ...
          {/* Date */}
          <span style={{ fontFamily:'"DM Mono"', fontSize:10, color:'#8A89A0' }}>
          ...
          <span style={{
            ...
            background: isAdmin ? '#004D3A' : '#2A2A3A',
            color: isAdmin ? '#00D2A0' : '#8A89A0',
            border: `1px solid ${isAdmin ? 'rgba(200,255,0,0.2)' : '#2A2A3A'}`,
          }}>
        ...
        {/* Content */}
        <main style={{ flex:1, overflowY:'auto', padding:'28px 28px', background:'#0F0F1A', color:'#F0EFF8' }}>
          <Outlet />
        </main>
      </div>
    </div>
